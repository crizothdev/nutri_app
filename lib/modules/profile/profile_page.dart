              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    _buildLabel('Nome'),
                    _buildField(user.name ?? 'nome', isEnabled: _isEditing),
                    _buildLabel('E-mail'),
                    _buildField(user.email ?? '', isEnabled: _isEditing),
                    _buildLabel('Telefone'),
                    _buildField(user.phone ?? '', isEnabled: _isEditing),
                    _buildLabel('Documento'),
                    _buildField(user.document ?? '', isEnabled: _isEditing),
